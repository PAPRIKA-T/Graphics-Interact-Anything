	...
	: QWidget(parent)
{
    ...
    file_view_btn->setIcon(QIcon(":/res/background-image/folder_stack_icon.png"));

    file_setting_btn = new GenericToolButton(this);
    file_setting_btn->setObjectName("stack_btn");
    file_setting_btn->setIcon(QIcon(":/res/background-image/setting_btn.png"));

    item_list_btn = new GenericToolButton(this);
    item_list_btn->setObjectName("stack_btn");
    item_list_btn->setIcon(QIcon(":/res/background-image/item_list_btn.png"));

    sam_model_btn = new GenericToolButton(this);
    sam_model_btn->setObjectName("stack_btn");
    sam_model_btn->setIcon(QIcon(":/res/background-image/sam_model_btn.png"));

    color_adjust_btn = new GenericToolButton(this);
    color_adjust_btn->setObjectName("stack_btn");
    color_adjust_btn->setIcon(QIcon(":/res/background-image/color_adjust_btn.png"));
